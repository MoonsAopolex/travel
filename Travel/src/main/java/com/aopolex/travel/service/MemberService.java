...
import com.aopolex.travel.bean.Result;
import com.aopolex.travel.mapper.MemberMapper;
...
public class MemberService {
    ...
    public String active(String activeCode) {
        ...
        if (member == null) {
            ...
            return "激活成功，请<a href='" + projectPath + "/frontdesk/login'>登录</a>></a>";
        }
    }
    ...
    public Result Login(String name, String password) {
        ...
        //返回member给controller层，然后存入session以验证用户是否登录成功
        //否则收藏等功能无法访问
